...
(function (global, factory) {
  ...
  function () {
    function SimpleBar(element, options) {
      ...
      this.offsetSize = 20;
      this.recalculate = lodash_throttle(this.recalculate.bind(this), 100);
      this.init();
    }
    ...
    _createClass(SimpleBar, [{
      ...
      value: function hideNativeScrollbar() {
		...
		this.scrollContentEl.style[this.isRtl ? 'paddingLeft' : 'paddingRight'] = "".concat(18, "px");
		this.scrollContentEl.style.marginBottom = "-".concat(17, "px");
		// Madness ends - Bill
