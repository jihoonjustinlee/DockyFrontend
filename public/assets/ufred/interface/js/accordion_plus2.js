  ...
  console.log(imageFilename)
    ...
    <button class="accordion">
      <div class="acc-container">
        <div class="acc-content">${headerArray[i]}</div>
        <div class="plus">&#43;</div>
      </div>
    </button>
    <div class="panel">
      <div class="content">${contentArray[i]}</div>
      <div class="image" style="background-image: url(assets/images/${imageFilename}${i+1}.jpg)"></div>
    </div>`);
