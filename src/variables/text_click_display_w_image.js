export default function createTextClickDisplayWImagePage(json){
  let limits = [
    "Option One:",
    "Option Two:",
    "Option Three:",
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="interface/css/text_click_display_w_image.css">
    <script src="interface/js/text_click_display_w_image.js"></script>
    <script>
